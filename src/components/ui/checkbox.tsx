  ...
  return (
    <input
      ...
      className={cn(
        ...
        "after:w-5 after:h-5 after:absolute after:top-0 after:left-0 checked:after:bg-blue-500 checked:after:border-blue-500 after:border after:border-zinc-800 bg-zinc-800 after:rounded-sm after:cursor-pointer",
