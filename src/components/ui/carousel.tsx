...
function CarouselContent({ className, ...props }: React.ComponentProps<'div'>) {
  ...
  return (
    <div ref={carouselRef} className="overflow-hidden backdrop-filter backdrop-blur-sm" data-slot="carousel-content">
      <div
        className={cn('flex gap-1.5', orientation === 'horizontal' ? '-ml-4' : '-mt-4 flex-col', className)}
        {...props}
      />
    </div>
  );
